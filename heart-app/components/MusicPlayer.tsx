...
const MusicPlayer = ({ selectedMusicUser }: MusicPlayerProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 p-4 rounded-lg flex flex-col md:flex-row items-center justify-center  w-full max-w-md md:max-w-3xl">
