...
export async function GET(
  ...
  const user = mockRegistrations.find(reg => reg.id === userId)
...
export async function PATCH(
  ...
  const userIndex = mockRegistrations.findIndex(reg => reg.id === userId)
  ...
  mockRegistrations[userIndex] = {
    ...mockRegistrations[userIndex],
    ...data
  }
  
  return NextResponse.json(mockRegistrations[userIndex])
}
...
export async function DELETE(
  ...
  mockRegistrations.splice(userIndex, 1)
